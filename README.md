...
The build process include some unit tests, and generates JUnit compatible result XML files in the
build directory for easy CI integration (one per variant, i.e: `junit-amd64-linux.xml`).
